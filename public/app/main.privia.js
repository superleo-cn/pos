...
require([ 'app', 'router', 'backbone', 'jquery.ui', 'jquery.validate', 'jquery.form', 'jquery.actual', 'bootstrap', 'bootstrap-timepicker', 'jquery.serializeObject', 'dataTables',
	...
	/*
	 * $(document).on("click", "a[data-parent]", function(evt) { var href = {
	 * prop: $(this).prop("href"), attr: $(this).attr("href") }; var root =
	 * location.protocol + "//" + location.host + app.root;
	 * console.log('href'+href); evt.preventDefault(); if (href.prop &&

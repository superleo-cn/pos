...
public class Messages {
	...
	public static String FOOD_LIST_ERROR_MESSAGE = "[System]-[Error]-[Shop({}) request food list failed.]";
	
	// Consumption Message
	public static String CONSUMPTION_LIST_ERROR = "[Consumption List Error]";
	public static String CONSUMPTION_LIST_ERROR_MESSAGE = "[System]-[Error]-[Shop({}) request consumption list failed.]";
